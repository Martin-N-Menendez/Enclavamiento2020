...
ahora = datetime.now()
ID0	= '00011A102'                    # ID del dispositivo (String)
ID1	= 'FF011C000'                    # ID del dispositivo (String)
...
STATE	   = 'Marcha'                    # Estado del equipo: Marcha, Parado, Falla, etc. (String)
...
def cmd_printInitialValues():
   ...
   print( 'Estado del equipo: Run, Stop, Err, etc. (String):', STATE )
   print( '' )
...
def cmd_printDataOutputFormat():
   ...
   formatoSalida = 'ID|DATE_GPS|TIME_GPS|LAT_GPS|LONG_GPS|HS_S|HS_P|HS_E|PS_MAX|PS_PROM|PS_MIN)|PD_MAX|PD_PROM|PD_MIN|DP_MAX|DP_PROM|DP_MIN'
...
def genOutputValues():
   return ID + '|' + DATE_GPS + '|' + TIME_GPS + '|' + str(LAT_GPS) + '|' + str(LONG_GPS) + '|' + str(HS_S) + '|' + str(HS_P) + '|' + str(HS_E) + '|' + STATE + '|' + str(PS_MAX) + '|' + str(PS_PROM) + '|' + str(PS_MIN) + '|' + str(PD_MAX) + '|' + str(PD_PROM) + '|' + str(PD_MIN) + '|' + str(DP_MAX) + '|' + str(DP_PROM) + '|' + str(DP_MIN) + '\r\n'
