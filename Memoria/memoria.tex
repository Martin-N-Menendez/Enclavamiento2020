...
{\scshape\LARGE Carrera de Maestría en Sistemas Embebidos\par}\vspace{1cm} % Thesis type
...
{Codirector:} \\
{Mg. Ing. Facundo Larosa (UTN)} % Supervisor name
...
Un enclavamiento es un sistema ferroviario, de alto costo y complejidad, que controla automáticamente que los cambios en las rutas se gestionen de forma segura, evitando choques y descarrilamientos de trenes. En base a un pedido de Trenes Argentinos y al análisis de sistemas de enclavameintos comerciales se propuso un enfoque de desarrollo para el diseño y la implementación  en tecnología FPGA. Se aplicaron técnicas apropiadas para lograr el nivel de seguridad requerido y se analizó la escalabilidad del diseño para dicha plataforma.                			
			
Para el desarrollo del trabajo resultó necesario aplicar conocimientos en lenguajes de descripción de hardware para la implementación del sistema sobre plataforma de lógica programable. Además, se trabajó el firmware bajo control de versiones y se aplicó el modelo de máquinas de estados finitos para la lógica del sistema. Se documentan las estrategias de testing adoptadas para validar los módulos. Finalmente, fueron fundamentales los conocimientos de sistemas críticos y ferroviarios.
...
% y permitido formarme cuando ésta no era suficiente. Agradezco enormemente su oferta de beca y deseo con fervor que el presente trabajo esté a la altura de sus expectativas. 

A mi Codirector, el Mg. Ing. Facundo Larosa, que disipó muchas de mis dudas y supo ser flexible en éste proyecto desde el comienzo cuando la meta no era tan clara. Sé que el año próximo podremos lograr grandes cosas juntos y el resultado será satisfactorio por demás.
