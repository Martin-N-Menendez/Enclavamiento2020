...
\author{Martín Nicolás Menéndez} % Tu nombre, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \authorname
\supervisor{Ariel Lutenberg (CONICET-FIUBA)} % El nombre del director, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \supname
...
{Codirector:} \\
{Facundo Larosa (UTN)} % Supervisor name
